                ...
                <div class="product-cards--container">
                    <div class="product-cards--col">
                        <div class="product-cards--grid">
                            ...
                            <div class="product-card" v-for="(menuItem) in allProducts[currentTabProduct].menuItems" :key="menuItem.id">
                                <div class="product-card--img" :style="{backgroundImage:`url(${menuItem.img})`}">
                                </div>
                                <div class="product-card--body">
                                    ...
                                    <div class="product-card--bottom">
                                        ...
                                        <div class="btn-add-card" @click="addProduct(menuItem)" data-target="#productModal" data-toggle="modal">Sepete Ekle</div>
                                    </div>
                                </div>
                            </div>
                            </transition-group>
                    ...
                    <div class="product-sepet--col">
                        <div class="product-sepet--container">
                           ...
                           <div class="sepet-products">
                                <template v-if="userInfos.cardTotal !== undefined || userInfos.cardTotal === 0">
                                    <div class="sepet-product" v-for="(cartItem) in allCartItems"
                                    :key="cartItem.id">
                                ...
                                <div class="sepet-product" v-else>
                                    <div class="title" style="width:100%;padding-top:10px;padding-bottom:10px;">
                        ...
                        <div class="product-sepet--banner">
                            <img src="https://www.tiklagelsin.com/cmsfiles/banners/helal-et-1.jpg?v=160" alt="">
                        </div>
                        <div class="product-sepet--banner">
                            <img src="https://www.tiklagelsin.com/cmsfiles/banners/ne-yedigini-bil-1.jpg?v=160" alt="">
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control-description">
                                                <div class="minusplusnumber">
                                                    <div class="mpbtn minus none-select" @click="product.quantity--">
                                                        - 
                                                    </div> 
                                                    <div id="field_container">
                                                        <span class="text-lg mr-4 ml-4 text-center none-select"><span class="text-muted text-lg"></span>{{product.quantity}}</span>
                                                    </div>
                                                    <div class="mpbtn plus none-select" @click="product.quantity++">
                                                        +
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group options">
                                                    <div class="custom-control custom-checkbox option-checkboxes" v-for="(option,i) in product.options" :key="i" @click="clickOption(option.id)" >
                                                        <!-- <input type="checkbox" class="custom-control-input"> -->
                                                        <!-- <span class="custom-control-indicator"></span> -->
                                                        <input id="cbx" type="checkbox" :checked="pickedOptions.findIndex(item=>item===option.id)!=-1 ? true : false"/>
                                                        <label class="cbx">
                                                            <div class="flip">
                                                                <div class="front"></div>
                                                                <div class="back">
                                                        ...
                                                        <span class="custom-control-description none-select">{{option.content}} </span>
                                                    </div>
                                                </div>
...
<style >
  .swal2-popup{
    ...
    .sepet-product .title, .sepet-product .price {
        font-size: 15px;
        font-weight: 500;
    }
    ...
    .product-card--title,.product-card--desc,.product-card--bottom{
        padding-top: 15px;
    }
    .product-card--body{
        padding: 25px;
