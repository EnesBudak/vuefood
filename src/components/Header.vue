  ...
  <header id="header" class="light">
        ...
        <div class="container">
            ...
            <div class="row">
             ...
             <li class="nav-item" >
                 <router-link to="/home" class="has-dropdown">
